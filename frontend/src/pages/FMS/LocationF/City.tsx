...
const City = () => {
    ...
    const deleteCity = async (city: any = null) => {
        await axios.delete(`${config.API_BASE_URL}/location/city/${city.city_id}`);
        showMessage('city has been deleted successfully.');
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                if (params.city_id) {
                    const response = await axios.put(`${config.API_BASE_URL}/location/citi/${params.city_id}`, values);
                    if (response.status === 200 || response.status === 204) {
                        showMessage(`City updated`);
                        formik.resetForm();
    ...
    const addcity = async (user: any = null) => {
                                        ...
                                        <tr key={contact.id}>
                                            ...
                                            <td>
                                                <div className="flex gap-4 items-center justify-center">
                                                    ...
                                                    <button type="button" className="btn btn-sm btn-outline-danger" onClick={() => deleteCity(contact)}>
                                                        Delete
                                                    </button>
                                                </div>
                                            </td>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {viewMode ? 'City Details' : params.city_id ? 'Edit City' : 'Add City'}
                                    </div>
                                    <div className="p-5">
